                    ...
                    >
                        ...
                        <div className={`grid transition-all duration-200 ${
                            ...
                            <div className="overflow-hidden">
                                <div className={`bg-gray-50 px-4 py-2 transform transition-transform duration-200 ${
                                    isActive ? 'translate-y-0' : '-translate-y-2'
                                }`}>
                                    {category.options.map((item, index) => (
                                        <div
                                            key={index}
                                            className="py-2 px-8 hover:bg-gray-100 cursor-pointer rounded transition-colors duration-150"
                                        >
                                            ⦁ {item}
                                        </div>
                                    ))}
